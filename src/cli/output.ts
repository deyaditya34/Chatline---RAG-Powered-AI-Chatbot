...
import { type Entity, type Job } from "../types/output.js";

export function printList(list: string[]): void {
...
export function printConversation(message: string, entity: Entity, job: Job): void {
...
export function printModelInfo(modelInfo: ModelInfo) {
	console.log(`\x1B[38;2;255;180;180m[model]: \x1B[0m`);
	console.table(modelInfo);
}

export function printModelList(modelList: ModelList[]) {
	console.log(`\x1B[38;2;255;180;180m[model]: \x1B[0m`);
