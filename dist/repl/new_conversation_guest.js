...
export async function newConversationGuest() {
    let userResponse;
    ...
    while (true) {
        ...
        let [modelResponse] = await generateContent(initital_conversation_boilerplate.contents);
...
//# sourceMappingURL=new_conversation_guest.js.map